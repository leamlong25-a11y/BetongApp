...
const Sidebar = ({ activePage, setActivePage }) => {
  const menuItems = [
    ...
    { id: "report", label: "របាយការណ៍", icon: "📈" },
    { id: "settings", label: "ការកំណត់", icon: "⚙️" },
  ];

  return (
    <div
      className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 flex justify-around items-center pt-2 pb-4 px-2 z-50 print:hidden shadow-[0_-4px_25px_rgba(0,0,0,0.5)]"
